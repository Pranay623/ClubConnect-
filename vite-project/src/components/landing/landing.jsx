...
const landing = () => {
  ...
  return (
     <div
      ...
      className="mt-6 px-6 py-3 text-white border-2 border-white rounded-lg shadow-lg hover:bg-white hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 transition duration-300 ease-in-out pointer-events-auto">
        SignIn
      </button>
    </div>
